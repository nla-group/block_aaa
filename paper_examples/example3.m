% compare all fitting algorithms on the CDplayer example from the SLICOT
% collection of MOR benchmarks
% 
% Available at:
...
for i = 1:npts
    FF{i} = full(C*((pts(i)*speye(nn)-A)\B));
end
...
legend('set-valued AAA','surrogate AAA','VF (5 iter)','VF (10 iter)','RKFIT (5 iter)',...
    'RKFIT (10 iter)','Loewner','block-AAA','Location','NorthEast');
